...
function TabSkeleton({ activeTab }: { activeTab: string }) {
  if (activeTab === 'dash') {
    return (
      <div id="skeleton-dash" className="space-y-6 animate-pulse">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-2">
          <div>
            <div className="h-6 w-48 bg-slate-200 dark:bg-slate-800 rounded-lg mb-2" />
            <div className="h-4 w-64 bg-slate-100/80 dark:bg-slate-800/50 rounded" />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="bg-white dark:bg-slate-900 border border-slate-105 dark:border-slate-800/80 rounded-2xl p-6 h-28">
              <div className="flex justify-between items-start mb-3">
                <div className="h-4 w-20 bg-slate-200 dark:bg-slate-800 rounded" />
                <div className="h-8 w-8 bg-slate-100 dark:bg-slate-800 rounded-full" />
              </div>
              <div className="h-6 w-28 bg-slate-200 dark:bg-slate-795 rounded" />
            </div>
          ))}
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-105 dark:border-slate-800/80 rounded-2xl p-6 h-80 flex flex-col justify-between">
            <div className="h-5 w-36 bg-slate-200 dark:bg-slate-800 rounded mb-4" />
            <div className="h-full w-full bg-slate-100 dark:bg-slate-800/35 rounded-xl animate-pulse" />
          </div>
          <div className="bg-white dark:bg-slate-900 border border-slate-105 dark:border-slate-800/80 rounded-2xl p-6 h-80 flex flex-col justify-between">
              ...
              {[...Array(4)].map((_, i) => (
                <div key={i} className="flex justify-between items-center py-2 border-b border-slate-50 dark:border-slate-800/40">
                  <div className="flex gap-2">
                    ...
                    <div>
                      <div className="h-3.5 w-16 bg-slate-150 dark:bg-slate-800 rounded" />
                      <div className="h-2.5 w-10 bg-slate-100 dark:bg-slate-800/50 rounded mt-2" />
                    </div>
                  </div>
  ...
  if (activeTab === 'ledger') {
    return (
      <div id="skeleton-ledger" className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-pulse">
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-105 dark:border-slate-800 rounded-2xl p-6 space-y-4">
            <div className="flex justify-between items-center mb-2">
              <div className="h-5 w-32 bg-slate-200 dark:bg-slate-800 rounded" />
              <div className="h-9 w-24 bg-slate-100 dark:bg-slate-800 rounded-lg" />
            </div>
            {[...Array(5)].map((_, i) => (
              <div key={i} className="flex justify-between items-center py-3.5 border-b border-slate-50 dark:border-slate-800/40 last:border-0">
                <div className="flex gap-3">
                  <div className="h-10 w-10 bg-slate-100 dark:bg-slate-800/80 rounded-xl" />
                  <div>
                    <div className="h-4 w-28 bg-slate-200 dark:bg-slate-795 rounded" />
                    <div className="h-3 w-16 bg-slate-150 dark:bg-slate-800/40 rounded mt-2" />
                  </div>
                </div>
                <div className="h-4 w-12 bg-slate-150 dark:bg-slate-800 rounded" />
              </div>
        ...
        <div className="lg:col-span-1 bg-white dark:bg-slate-900 border border-slate-105 dark:border-slate-800 rounded-2xl p-6 h-96 space-y-5">
          <div className="h-5 w-28 bg-slate-200 dark:bg-slate-800 rounded" />
          {[...Array(4)].map((_, i) => (
            <div key={i} className="space-y-2">
              <div className="h-3 w-16 bg-slate-155 dark:bg-slate-800/40 rounded" />
  ...
  if (activeTab === 'finance' || activeTab === 'savings' || activeTab === 'templates' || activeTab === 'recurring') {
    return (
      <div id={`skeleton-${activeTab}`} className="space-y-6 animate-pulse">
        <div className="h-8 w-44 bg-slate-200 dark:bg-slate-800 rounded-lg" />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="bg-white dark:bg-slate-900 border border-slate-105 dark:border-slate-800 rounded-2xl p-6 space-y-4">
              ...
              <div className="flex justify-between items-center">
                <div className="h-3 w-16 bg-slate-150 dark:bg-slate-805 rounded" />
                <div className="h-3 w-20 bg-slate-150 dark:bg-slate-805 rounded" />
              </div>
            </div>
          ))}
        </div>
  ...
  return (
    <div id="skeleton-generic" className="bg-white dark:bg-slate-900 border border-slate-105 dark:border-slate-800 rounded-2xl p-8 space-y-6 animate-pulse">
      <div className="h-6 w-48 bg-slate-200 dark:bg-slate-800 rounded-lg" />
      <div className="space-y-3">
        <div className="h-4 w-full bg-slate-100 dark:bg-slate-800/60 rounded" />
        <div className="h-4 w-[92%] bg-slate-100 dark:bg-slate-800/60 rounded" />
        <div className="h-4 w-[88%] bg-slate-100 dark:bg-slate-800/60 rounded" />
        <div className="h-4 w-[95%] bg-slate-100 dark:bg-slate-800/60 rounded" />
      </div>
    </div>
  );
}
    ...
    <div className={`min-h-screen w-full max-w-full overflow-x-hidden ${darkMode ? 'dark bg-slate-950 text-slate-100' : 'bg-slate-50/70 text-gray-800'} transition-colors duration-200 antialiased flex flex-col font-sans pb-16 lg:pb-6`}>
      ...
      <main id="main-content" className="max-w-7xl mx-auto w-full px-4 pt-8 pb-28 lg:pb-8 flex-1 grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <section className="lg:col-span-3 space-y-8 min-h-[500px]">
          ...
          <React.Suspense fallback={<TabSkeleton activeTab={activeTab} />}>
            {activeTab === 'dash' && (
              <Dashboard 
